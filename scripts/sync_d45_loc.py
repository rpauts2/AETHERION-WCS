...
# For D4-D8 races, ensure abilities have localized placeholders for n/d
strings = set()
for r in obj:
...
ru_path = Path('C:/Users/Administrator/Desktop/AETHERION-WCS/lang/ru.json')
en_path = Path('C:/Users/Administrator/Desktop/AETHERION-WCS/lang/en.json')
