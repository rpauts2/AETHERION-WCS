...
import human, files3d, log
from core import G

# stub app с progress/мелочами
class StubApp:
...
fbx_utils=loadmod("fbx_utils"); mh2fbx=loadmod("mh2fbx")

# Родной конфиг экспорта
from export import Exporter, ExportConfig
cfg = ExportConfig()
cfg.scale = 1.0
cfg.unit = "m"
cfg.feetOnGround = True
cfg.scaleAndUnit = (1.0, "m")
cfg.human = h
cfg.subdivide = False
cfg.binary = True
...
cfg.useCustomTargets = False
try:
    cfg.setHuman(h)
except Exception as e: print("setHuman skip:", e)
